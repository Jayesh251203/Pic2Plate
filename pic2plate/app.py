...
# Custom CSS
st.markdown(""" ... """, unsafe_allow_html=True)  # keeping your CSS intact
                ...
                types.Content(
                    ...
                    parts=[
                        types.Part.from_text(
                            text="List all the food items you can see in this fridge image. Provide the list in a comma-separated format."
                        ),
...
# --- rest of your code (init_session_state, show_progress, tooltip, home_page, upload_images_page,
# identify_ingredients_page, generate_recipe_page, main) stays unchanged ---
